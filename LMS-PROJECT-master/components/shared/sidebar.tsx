...
export function Sidebar({ isOpen = true, onClose }: SidebarProps) {
  ...
  return (
    <aside className={`fixed left-0 top-0 z-40 h-screen w-64 bg-[#21647f] text-white transition-transform duration-300 lg:translate-x-0 ${
      isMobile && !isOpen ? "-translate-x-full" : ""
    }`}>
      <div className="flex h-full flex-col">
        {/* Logo/Brand */}
        <div className="flex h-16 items-center justify-between border-b border-teal-700 px-6">
