...
import { Download, TrendingUp, Users, BookOpen, CircleDollarSign } from "lucide-react"

export default function AdminReportsPage() {
  const handleExport = () => {
    const rows = [
      ["Metric", "Value"],
      ["Total Revenue", `R${mockAdminStats.monthlyRevenue.toLocaleString()}`],
      ["New Enrollments", "234"],
      ["Course Completions", "89"],
      ["Avg. Satisfaction", "4.6/5"],
      [],
      ["Top Course", "Enrollments", "Completion Rate"],
      ["Introduction to Web Development", "245", "78%"],
      ["Data Science Fundamentals", "198", "72%"],
      ["Advanced React Patterns", "156", "85%"],
      ["Project Management Essentials", "134", "91%"],
    ]
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button className="gap-2 bg-[#005792] hover:bg-[#00437a]" onClick={handleExport}>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">R{mockAdminStats.monthlyRevenue.toLocaleString()}</div>
            ...
            {[
              ...
              <div key={index} className="flex items-center justify-between rounded-lg border p-4">
                <div className="flex items-center gap-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#005792]/10 text-lg font-bold text-[#005792]">
                    {index + 1}
                  </div>
                  <div>
