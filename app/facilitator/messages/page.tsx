...
const initialMessages: Message[] = [
  ...
  { id: "5", sender: "student", text: "Thank you for the feedback!", time: "10:40 AM" },
]
            ...
            <div className="flex-1 space-y-4 overflow-y-auto p-4">
              {messages.map((message) => (
                <div
                  key={message.id}
                  className={`flex ${
                    message.sender === "facilitator" ? "justify-end" : "justify-start"
                  }`}
                >
                  <div
                    className={`max-w-[70%] rounded-lg p-3 ${
                      message.sender === "facilitator"
                  ...
                  >
                    ...
                    <p
                      className={`mt-1 text-xs ${
                        message.sender === "facilitator" ? "text-teal-200" : "text-muted-foreground"
                      }`}
                    >
                      {message.time}
                    </p>
